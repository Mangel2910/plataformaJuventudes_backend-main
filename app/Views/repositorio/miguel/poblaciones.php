...
<section class="m-5 text-center grid grid-cols-3 gap-3 flex">
    <div class="w-full max-w-xs overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg shadow-slate-950/5 ">
        <img class="m-1.5 h-max w-[calc(100%-12px)] rounded-[5px]" src="/PMJ_MOSQUERA-12.png.svg" alt="profile-picture" />
